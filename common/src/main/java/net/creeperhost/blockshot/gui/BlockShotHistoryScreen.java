...
public class BlockShotHistoryScreen extends Screen {
    ...
    protected void init() {
        ...
        copyButton = addRenderableWidget(new Button(width / 2 - (76 * 2), height - 28, 72, 20, new TranslatableComponent("gui.blockshot.history.copy_url"), e -> screenList.getCurrSelected().copyUrl()));
        deleteButton = addRenderableWidget(new Button(width / 2 - 76, height - 28, 72, 20, new TranslatableComponent("gui.blockshot.history.delete"), e -> deleteSelected()));
        viewButton = addRenderableWidget(new Button(width / 2, height - 28, 72, 20, new TranslatableComponent("gui.blockshot.history.view"), (arg) -> screenList.getCurrSelected().openUrl()));
        ...
        IconButton gearButton = addRenderableWidget(new IconButton(width - 28, height - 28, 20, 20, null, e -> minecraft.setScreen(new BlockShotSettingsScreen(this)), (button, poseStack, i, j) -> renderTooltip(poseStack, new TranslatableComponent("gui.blockshot.settings.open.info"), i, j)));
