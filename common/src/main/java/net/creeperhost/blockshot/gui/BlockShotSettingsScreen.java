...
public class BlockShotSettingsScreen extends Screen {
    ...
    protected void init() {
        ...
        addRenderableWidget(new Button(xPos, yPos, 204, 20, new TextComponent(value2), button -> {
        ...
        //Upload Mode
        addRenderableWidget(new Button(xPos, yPos, 204, 20, new TranslatableComponent(Config.INSTANCE.uploadMode.translatableName()), button -> {
        ...
        //Button Position
        addRenderableWidget(new Button(xPos, yPos, 204, 20, new TranslatableComponent(Config.INSTANCE.buttonPos.translatableName()), button -> {
        ...
        RadioButton setGif = addRenderableWidget(new RadioButton(xPos, yPos, 101, 20, new TranslatableComponent("gui.blockshot.settings.encoder.gif"), button -> {
        ...
        RadioButton setMOV = addRenderableWidget(new RadioButton(xPos + 104, yPos, 101, 20, new TranslatableComponent("gui.blockshot.settings.encoder.mov"), button -> {
