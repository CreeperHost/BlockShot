...
public interface Encoder {
    ...
    default Component getStopText() {
        ...
        return new TranslatableComponent("overlay.blockshot.finish", screenshotKey).withStyle(ChatFormatting.GRAY);
    }

    default Component getCancelText() {
        String screenshotKey = Minecraft.getInstance().options.keyScreenshot.getTranslatedKeyMessage().getString();
        return new TranslatableComponent("overlay.blockshot.cancel", screenshotKey).withStyle(ChatFormatting.GRAY);
    }
